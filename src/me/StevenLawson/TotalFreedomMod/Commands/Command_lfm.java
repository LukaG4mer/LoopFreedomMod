...
@CommandParameters(description = "Shows information about LoopFreedomMod or reloads it", usage = "/<command> [reload]")
public class Command_lfm extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        playerMsg("Looking for totalfreedommod info? /tfm!", ChatColor.GREEN );
        ...
        playerMsg("FOPM Addition created by looperXD", ChatColor.GOLD);
        playerMsg("Visit " + ChatColor.AQUA + "http://loopfreedom.boards.net/ " + ChatColor.GREEN + " for more information.", ChatColor.GREEN);
