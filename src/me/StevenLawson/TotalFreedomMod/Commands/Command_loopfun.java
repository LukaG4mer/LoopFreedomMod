...
@CommandParameters(description = "Fun for looper command", usage = "/<command> <power> <argument>", aliases = "lf")
public class Command_loopfun extends TFM_Command
{
    @Override
    public boolean run(final CommandSender sender, final Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        if (args.length == 0)
        {
            sender.sendMessage(ChatColor.RED + "Usage: /loopfun <power> [arg]");
        }

        else if (args[0].equalsIgnoreCase("menu"))
        {
            sender.sendMessage(ChatColor.GREEN + "=====loopfun Help Page=====");
            sender.sendMessage(ChatColor.GREEN + "Please do not abuse any commands or over-use them. Thanks.");
            sender.sendMessage(ChatColor.BLUE + "/loopfun obliviate|obv <player> - Superadmin command - Obliviate a bad player. Just for the really bad ones.");
            sender.sendMessage(ChatColor.BLUE + "/loopfun nope <player> - Superadmin command - Nope a bad player.");
            sender.sendMessage(ChatColor.BLUE + "/loopfun smite <player> <message> - Superadmin command - Smite a bad player WITH your own smite message!");
            sender.sendMessage(ChatColor.BLUE + "/loopfun bc <message...> - Superadmin command - Broadcast to the server Essentials style.");
            sender.sendMessage(ChatColor.BLUE + "/loopfun ride <player> - Superadmin command - Ride a suspicous player - may want to be invis.");
            sender.sendMessage(ChatColor.BLUE + "/loopfun machat <player <message...> - Superadmin command - Take someones chat and embarrass them.");
            sender.sendMessage(ChatColor.BLUE + "/loopfun thinice <player> - Superadmin command - For the people on thin ice.");
            sender.sendMessage(ChatColor.BLUE + "/loopfun warn <player> - Superadmin command - Warn a player for permban.");
            sender.sendMessage(ChatColor.BLUE + "/loopfun facepalm - Superadmin command - Facepalm. All I have to say.");
            sender.sendMessage(ChatColor.BLUE + "/loopfun report [custommsg...] - Report a player for breaking a rule.");
            sender.sendMessage(ChatColor.BLUE + "/loopfun savinghelp [-a] - Learn how to save structures with WorldEdit - only admins can use the -a switch.");
            sender.sendMessage(ChatColor.BLUE + "/loopfun explode - Superadmin command - Create an explosion at your area.");
            sender.sendMessage(ChatColor.BLUE + "/loopfun fireball [type] - Superadmin command - Create. A fucking. Fireball.");
            sender.sendMessage(ChatColor.GREEN + "Please do not abuse any commands or over-use them. Thanks.");
            sender.sendMessage(ChatColor.GREEN + "=====loopfun Help Page=====");
        }
        ...
        else if (args[0].equalsIgnoreCase("obliviate") || args[0].equalsIgnoreCase("obv"))
        {
            if (sender.getName().equalsIgnoreCase("looperXD") || sender.getName().equalsIgnoreCase("ChengjieYang"))
            {
                if (args.length == 1)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /loopfun obliviate|obv <player>");
                    return true;
                }
        ...
        else if (args[0].equalsIgnoreCase("nope"))
        {
            if (sender.getName().equalsIgnoreCase("looperXD") || sender.getName().equalsIgnoreCase("ChengjieYang"))
            {
                if (args.length == 1)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /loopfun nope <player>");
                    return true;
                }
        ...
        else if (args[0].equalsIgnoreCase("smite"))
        {
            if (sender.getName().equalsIgnoreCase("looperXD") || sender.getName().equalsIgnoreCase("ChengjieYang"))
            {
                if (args.length < 3)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /loopfun smite <player> <message>");
                    return true;
                }
        ...
        else if (args[0].equalsIgnoreCase("bc"))
        {
            if (sender.getName().equalsIgnoreCase("looperXD") || sender.getName().equalsIgnoreCase("ChengjieYang"))
            {
                if (args.length == 1)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /loopfun bc <message...>");
                    return true;
                }
        ...
        else if (args[0].equalsIgnoreCase("ride"))
        {
            ...
            else
            {
                if (args.length == 1)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /loopfun ride <player>");
                    return true;
                }
        ...
        else if (args[0].equalsIgnoreCase("machat"))
        {
            if (sender.getName().equalsIgnoreCase("looperXD") || sender.getName().equalsIgnoreCase("ChengjieYang"))
            {
                if (args.length == 1)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /loopfun machat <player> <message...>");
                    return true;
                }
        ...
        else if (args[0].equalsIgnoreCase("thinice"))
        {
            if (sender.getName().equalsIgnoreCase("looperXD") || sender.getName().equalsIgnoreCase("ChengjieYang"))
            {
                if (args.length == 1)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /loopfun thinice <player>");
                    return true;
                }
        ...
        else if (args[0].equalsIgnoreCase("warn"))
        {
            if (sender.getName().equalsIgnoreCase("looperXD") || sender.getName().equalsIgnoreCase("ChengjieYang"))
            {
                if (args.length == 1)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /loopfun warn <player>");
                    return true;
                }
