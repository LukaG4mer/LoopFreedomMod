...
@CommandParameters(description = "Too much fun", usage = "/<command> <power> <argument>", aliases = "ff")
public class Command_farahfun extends TFM_Command
{
    @Override
    public boolean run(final CommandSender sender, final Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        if (args.length == 0)
        {
            sender.sendMessage(ChatColor.RED + "Usage: /farahfun <power> [arg]");
        }

        else if (args[0].equalsIgnoreCase("menu"))
        {
            sender.sendMessage(ChatColor.GREEN + "=====farahfun Help Page=====");
            sender.sendMessage(ChatColor.GREEN + "Please do not abuse any commands or over-use them. Thanks.");
            sender.sendMessage(ChatColor.BLUE + "/farahfun obliviate|obv <player> - Superadmin command - Obliviate a bad player. Just for the really bad ones.");
            sender.sendMessage(ChatColor.BLUE + "/farahfun nope <player> - Superadmin command - Nope a bad player.");
            sender.sendMessage(ChatColor.BLUE + "/farahfun smite <player> <message> - Superadmin command - Smite a bad player WITH your own smite message!");
            sender.sendMessage(ChatColor.BLUE + "/farahfun bc <message...> - Superadmin command - Broadcast to the server Essentials style.");
            sender.sendMessage(ChatColor.BLUE + "/farahfun ride <player> - Superadmin command - Ride a suspicous player - may want to be invis.");
            sender.sendMessage(ChatColor.BLUE + "/farahfun machat <player <message...> - Superadmin command - Take someones chat and embarrass them.");
            sender.sendMessage(ChatColor.BLUE + "/farahfun thinice <player> - Superadmin command - For the people on thin ice.");
            sender.sendMessage(ChatColor.BLUE + "/farahfun warn <player> - Superadmin command - Warn a player for permban.");
            sender.sendMessage(ChatColor.BLUE + "/farahfun facepalm - Superadmin command - Facepalm. All I have to say.");
            sender.sendMessage(ChatColor.BLUE + "/farahfun report [custommsg...] - Report a player for breaking a rule.");
            sender.sendMessage(ChatColor.BLUE + "/farahfun savinghelp [-a] - Learn how to save structures with WorldEdit - only admins can use the -a switch.");
            sender.sendMessage(ChatColor.BLUE + "/farahfun explode - Superadmin command - Create an explosion at your area.");
            sender.sendMessage(ChatColor.BLUE + "/farahfun fireball [type] - Superadmin command - Create. A fucking. Fireball.");
            sender.sendMessage(ChatColor.GREEN + "Please do not abuse any commands or over-use them. Thanks.");
            sender.sendMessage(ChatColor.GREEN + "=====farahfun Help Page=====");
        }
        ...
        {
            if (sender.getName().equalsIgnoreCase("FarahIsAwesome") || sender.getName().equalsIgnoreCase("ChengjieYang"))
            {
                if (args.length == 1)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /farahfun obliviate|obv <player>");
                    return true;
                }
        ...
        else if (args[0].equalsIgnoreCase("nope"))
        {
            if (sender.getName().equalsIgnoreCase("FarahIsAwesome") || sender.getName().equalsIgnoreCase("ChengjieYang"))
            {
                if (args.length == 1)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /farahfun nope <player>");
                    return true;
                }
        ...
        else if (args[0].equalsIgnoreCase("smite"))
        {
            if (sender.getName().equalsIgnoreCase("FarahIsAwesome") || sender.getName().equalsIgnoreCase("ChengjieYang"))
            {
                if (args.length < 3)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /farahfun smite <player> <message>");
                    return true;
                }
        ...
        else if (args[0].equalsIgnoreCase("bc"))
        {
            if (sender.getName().equalsIgnoreCase("FarahIsAwesome") || sender.getName().equalsIgnoreCase("ChengjieYang"))
            {
                if (args.length == 1)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /farahfun bc <message...>");
                    return true;
                }
        ...
        {
            if (sender.getName().equalsIgnoreCase("FarahIsAwesome") || sender.getName().equalsIgnoreCase("ChengjieYang") || sender instanceof ConsoleCommandSender)
            {
            ...
            else
            {
                if (args.length == 1)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /farahfun ride <player>");
                    return true;
                }
        ...
        else if (args[0].equalsIgnoreCase("machat"))
        {
            if (sender.getName().equalsIgnoreCase("FarahIsAwesome") || sender.getName().equalsIgnoreCase("ChengjieYang"))
            {
                if (args.length == 1)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /farahfun machat <player> <message...>");
                    return true;
                }
        ...
        else if (args[0].equalsIgnoreCase("thinice"))
        {
            if (sender.getName().equalsIgnoreCase("FarahIsAwesome") || sender.getName().equalsIgnoreCase("ChengjieYang"))
            {
                if (args.length == 1)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /farahfun thinice <player>");
                    return true;
                }
        ...
        else if (args[0].equalsIgnoreCase("warn"))
        {
            if (sender.getName().equalsIgnoreCase("FarahIsAwesome") || sender.getName().equalsIgnoreCase("ChengjieYang"))
            {
                if (args.length == 1)
                {
                    sender.sendMessage(ChatColor.RED + "Usage: /farahfun warn <player>");
                    return true;
                }
