...
@CommandParameters(description = "Graces the world with red. Command that is pretty pointless unless you are loop.", usage = "/<command>")
public class Command_red extends TFM_Command
{

    @Override
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
             if (!sender.getName().equals("looperXD") && !sender.getName().equals("Taoist_Miner") && !sender.getName().equals("Soniccrafter237"))
        {
            sender_p.sendMessage(ChatColor.RED + "Only Owner and Co-Owners may use this command.");
          ...
          for(Player player : Bukkit.getOnlinePlayers())
                {
                    ...
                    ItemStack CamWool = new ItemStack(Material.WOOL, 1, (short)14);
                    ...
                    meta.setDisplayName(ChatColor.RED + "Red Aura");
                    Object lore = Arrays.asList(new String[] { ChatColor.BLUE + "This aura should protect", ChatColor.BLUE + "you from being fucked, seems legit." });
                ...
                World world = player.getWorld();
                Location loc = player.getLocation();
                TFM_Util.adminAction(sender_p.getName(), "Gracing the world with Red!", false);
                world.strikeLightningEffect(loc);
                TFM_Util.adminAction(sender_p.getName(), "Gracing the world with Red!", false);
                world.strikeLightningEffect(loc);
                TFM_Util.adminAction(sender_p.getName(), "Gracing the world with Red!", false);
        ...
        for(Player player : Bukkit.getOnlinePlayers())
                ...
                meta.setDisplayName(ChatColor.DARK_RED + "The Red Shot");
                Object lore = Arrays.asList(new String[] { ChatColor.BLUE + "Legend has it, this bow", ChatColor.BLUE + "can only shoot red arrows!" });
                meta.setLore((List)lore);
                ...
                meta.setDisplayName(ChatColor.DARK_GREEN + "The Red Blade");
                Object lore = Arrays.asList(new String[] { ChatColor.BLUE + "The red has the power", ChatColor.BLUE + "to wield this legendary blade!" });
                meta.setLore((List)lore);
                ...
                meta.setDisplayName(ChatColor.RED + "Red Arrow");
                Object lore = Arrays.asList(new String[] { ChatColor.BLUE + "This arrow has a mysterious", ChatColor.BLUE + "red aura around it..." });
                meta.setLore((List)lore);
