...
public class Command_asshole extends TFM_Command
{
    ...
    {
        TFM_Util.bcastMsg(String.format("%s is being such a fucking stupid ass asshole, and needs to stop.\nThey have thus been smitten!\n" + ChatColor.GOLD + "Reason: %s", player.getName(), reason), ChatColor.RED);
    ...
    {
        TFM_Util.bcastMsg(player.getName() + " is being such a fucking stupid ass asshole, and needs to stop.\nThey have thus been smitten!", ChatColor.RED);
        //Deop
        player.setOp(false);
