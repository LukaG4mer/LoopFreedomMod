...
public class TotalFreedomMod extends JavaPlugin
{
    ...
    public static final String FREEDOMOP_MOD = ChatColor.GRAY + "[" + ChatColor.RED + "LoopFreeedomMod" + ChatColor.GRAY + "]";
    public static final String FREEDOMOP_MODREPORT = ChatColor.WHITE + "[" + ChatColor.DARK_GREEN + "LoopFreedom Report" + ChatColor.WHITE + "]";
    //
